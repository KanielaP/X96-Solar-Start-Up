...
<br> Rewards goes between both agent and environemnt where the agent would compare and update value. However, for purposes of simplicity it is left out and will be implemented in furture build. 
